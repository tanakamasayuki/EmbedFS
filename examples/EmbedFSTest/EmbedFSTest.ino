...
void setup()
{
    ...
    listDir(EmbedFS, "/", 3);
    createDir(EmbedFS, "/mydir");
    writeFile(EmbedFS, "/mydir/hello2.txt", "Hello2");
    listDir(EmbedFS, "/", 1);
    deleteFile(EmbedFS, "/mydir/hello2.txt");
    removeDir(EmbedFS, "/mydir");
    listDir(EmbedFS, "/", 1);
    writeFile(EmbedFS, "/hello.txt", "Hello ");
    appendFile(EmbedFS, "/hello.txt", "World!\r\n");
    readFile(EmbedFS, "/hello.txt");
    renameFile(EmbedFS, "/hello.txt", "/foo.txt");
    readFile(EmbedFS, "/foo.txt");
    deleteFile(EmbedFS, "/foo.txt");
    testFileIO(EmbedFS, "/test.txt");
    deleteFile(EmbedFS, "/test.txt");
